...
/**
 * COPIED FROM https://github.com/cloudstateio/cloudstate/blob/master/project/GraalVMPlugin.scala
 * WHO COPIED AND ADAPTED FROM https://github.com/sbt/sbt-native-packager/pull/1251
 *
